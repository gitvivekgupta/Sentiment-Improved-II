...
from compute import compute_same

from func import trans_eng_2_hin, trans_hin_2_eng, get_senti, spell_correct

from diction import google_english_2_hindi, google_hindi_2_english, hindi_2_english, hinglish_2_hindi, hindi_2_english_list
from diction import hinglish_2_hindi_list, _google_hindi_2_english_, _google_english_2_hindi_
                    ...
                    if(find_pos == -1 and find_neg == -1 and find_neu == -1):
                        ...
                        if(start == -1):
                            ...
                            if(check == "e"):
                                ...
                                sent_score = compute_same.compute_score(polarity, sent_score)
